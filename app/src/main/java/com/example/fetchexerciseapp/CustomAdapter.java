...
public class CustomAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        itemName.setText("Name : " + detailInfo.getlistId().trim());
        TextView childItem = (TextView) view.findViewById(R.id.itemId);
        childItem.setText("ID : " + detailInfo.getName().trim());
        TextView listId = (TextView) view.findViewById(R.id.listId);
        listId.setText("ListID : " + detailInfo.getId().trim());
    ...
    public View getGroupView(int groupPosition, boolean isLastChild, View view,
        ...
        heading.setText("List ID: " + headerInfo.getName().trim());
